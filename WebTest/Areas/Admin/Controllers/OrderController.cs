...
namespace WebTest.Areas.Admin.Controllers
{
    ...
    public class OrderController : Controller
    {
        ...
        public ActionResult Partial_DichVu(int id)
        {
        ...
        [HttpPost]
        public ActionResult UpdateTT(int id, int trangthai, int typepayment)
        {
            try
            {
                var item = db.Orders.Find(id);
            ...
            {
                               return Json(new { message = "Đã xảy ra lỗi: " + ex.Message, Success = false });
            }
        }
        ...
        //                join p in db.Service on od.ServiceId equals p.Id
        //                select new
        //                {
